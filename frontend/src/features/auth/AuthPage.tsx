  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        {/* Header */}
        <div className="text-center">
          <img src={logoSvg} alt="Checkin" className="mx-auto h-12 w-auto" />
        ...
        <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-xl p-6 border border-violet-100">
          <h3 className="text-sm font-semibold text-violet-900 mb-3">What you get with Checkin:</h3>
          <ul className="space-y-2">
            {[
              ...
              <li key={feature} className="flex items-start text-sm text-violet-700">
                <svg className="h-5 w-5 text-violet-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
