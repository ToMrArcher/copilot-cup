                    ...
                    {user.id === currentUser.id ? (
                      ...
                      <div className="flex items-center space-x-2">
                        <select
                          ...
                          className="block w-28 text-sm border-gray-300 rounded-md shadow-sm focus:ring-violet-500 focus:border-violet-500 disabled:opacity-50"
                        >
      ...
      <div className="mt-8 bg-gray-50 rounded-xl p-6 border border-gray-200">
        ...
        <div className="space-y-3">
          <div className="flex items-start">
            ...
            <p className="text-sm text-gray-600">Can view dashboards and KPIs. Read-only access.</p>
          </div>
          <div className="flex items-start">
            ...
            <p className="text-sm text-gray-600">Can create and modify dashboards, KPIs, and integrations.</p>
          </div>
          <div className="flex items-start">
